	...
	<div class="container">
		...
		<form action="update.do" method="post" class="form-horizontal">
		  <div class="form-group">
		    ...
		    <div class="col-sm-10">
		      <input type="text" value="${bean.sabun }" name="sabun" class="sabun" id="sabun" placeholder="사번입력" readonly="readonly">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="name" class="col-sm-2 control-label">이름</label>
		    <div class="col-sm-10">
		      <input type="text" value="${bean.name }" name="name" class="name" id="name" placeholder="이름입력">
		    </div>
		  </div>
		  <div class="form-group">
		    <label for="pay" class="col-sm-2 control-label">금액</label>
		    <div class="col-sm-10">
		      <input type="text" value="${bean.pay }" name="pay" class="pay" id="pay" placeholder="금액입력">
		    </div>
		  </div>
		  <div class="form-group">
